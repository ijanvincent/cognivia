  ...
  "feedback": "Brief explanation (1-2 sentences)"
    ...
    const finishStudySession = async () => {
        try {
            ...
            // Update deck mastery via Laravel API
        ...
        >
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.answerSection}>
                    ...
                    {!showResult && (
                        <TouchableOpacity
                            style={[styles.checkButton, { backgroundColor: colors.primary }, isChecking && styles.checkButtonDisabled]}
                            onPress={checkAnswer}
                            disabled={isChecking}
                        >
                            {isChecking ? (
                    ...
                    {showResult && (
                        <View style={[styles.resultBox, {
                            ...
                            <View style={styles.resultHeader}>
                                <MaterialCommunityIcons name={isCorrect ? "check-circle" : "close-circle"} size={32} color={isCorrect ? '#4CAF50' : '#F44336'} />
            ...
            <View style={styles.bottomButtons}>
                {showResult ? (
                    <TouchableOpacity style={[styles.nextButton, { backgroundColor: colors.primary }]} onPress={handleNext}>
                        <Text style={styles.nextButtonText}>{currentIndex === flashcards.length - 1 ? 'Finish' : 'Next Card'}</Text>
                        <MaterialCommunityIcons name="chevron-right" size={24} color="#000000" />
                    </TouchableOpacity>
                ) : (
                    <TouchableOpacity style={[styles.skipButton, { borderColor: colors.border }]} onPress={handleNext}>
