...
const DashboardScreen = ({ navigation }) => {
    ...
    const DeckCard = ({ deck }) => {
        ...
        const handleOptions = (deck, event) => {
            ...
            Alert.alert(deck.title, "Choose an action:", [
                ...
                },
                {
                    ...
                    style: 'destructive',
                    onPress: () => {
                        Alert.alert("Confirm Removal", `Are you sure you want to remove ${deck.title}? This cannot be undone.`, [
        ...
        return (
            <TouchableOpacity
                style={[styles.card, { backgroundColor: colors.card, borderLeftColor: masteryColor, shadowColor: colors.shadow }]}
            ...
            >
                ...
                <View style={styles.cardDetailsRow}>
                    ...
                    <View style={styles.masteryContainer}>
                        <Text style={[styles.masteryText, { color: masteryColor }]}>{deck.mastery}% Mastered</Text>
                ...
                <View style={[styles.progressRow, { borderTopColor: colors.border }]}>
                    <View style={styles.progressLeft}>
                        <MaterialCommunityIcons
                            ...
                            size={18} color={colors.primary} style={styles.progressIcon}
                        />
