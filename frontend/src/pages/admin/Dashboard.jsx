                        ...
                        <PanelBody>
                            <div className="row g-3">
                                {[
                                    ...
                                    { icon: 'fa-chart-column',   label: 'Page Views',  value: TOTAL_VISITS.toLocaleString(),      color: '#0d6efd' },
                                    { icon: 'fa-trash-can',      label: 'Deleted',     value: stats.total_deleted_users,          color: '#ef476f' },
                                    { icon: 'fa-arrow-trend-up', label: 'Growth',      value: growthRate + '%',                   color: '#7209b7' },
